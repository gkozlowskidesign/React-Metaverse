...
return (
    ...
    <div className='w-full px-10 h-100 bg-gradient-to-b from-indigo-700 to-black'> 
...
<ul class="space-y-8">
<li>
    <a href="https://github.com/MetaverseOfThings" class="flex items-center space-x-3 hover:text-indigo-400 transition">
...
<span class="block text-gray-300">MetaverseOfThings
    <br></br>
  &copy; 2022</span>
</div>
</div>
