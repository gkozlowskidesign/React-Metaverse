                        ...
                        <div class="bg-gray-100 sm:grid grid-cols-5 grid-rows-1 px-4 py-6 min-w-full lg:min-w-screen space-y-6 sm:space-y-0 sm:gap-4">
                            <div class="h-96 col-span-4 bg-gradient-to-tr from-indigo-800 to-indigo-500 rounded-md flex items-center">
                                <div class="ml-20 w-80">
                                    <h2 class="text-white text-4xl font-extrabold">MVoT Foundation</h2>

                                    <a href="https://www.metaverseot.xyz/" class="uppercase inline-block mt-8 text-sm bg-white py-2 px-4 rounded font-semibold hover:bg-indigo-100">get start</a>
                                </div>
                            </div>
...
<div class="px-3 md:lg:xl:px-40   border-t border-b py-20 bg-opacity-10" >
    ...
    <div class="grid grid-cols-1 md:lg:xl:grid-cols-3 group bg-white shadow-xl shadow-neutral-100 border ">
            ...
            <div
                ...
                <p class="text-xl font-medium text-slate-700 mt-3">Get Started</p>
            ...
            <div
                ...
                <p class="text-xl font-medium text-slate-700 mt-3">Solutions</p>
            ...
            <div class="p-10 flex flex-col items-center text-center group   md:lg:xl:border-b hover:bg-slate-50 cursor-pointer">
                ...
                <p class="text-xl font-medium text-slate-700 mt-3">Learning</p>
            ...
            <div class="p-10 flex flex-col items-center text-center group   md:lg:xl:border-r hover:bg-slate-50 cursor-pointer">
                ...
                <p class="text-xl font-medium text-slate-700 mt-3">Foundations</p>
            ...
            <div class="p-10 flex flex-col items-center text-center group    md:lg:xl:border-r hover:bg-slate-50 cursor-pointer">
                ...
                <p class="text-xl font-medium text-slate-700 mt-3">Connect</p>
