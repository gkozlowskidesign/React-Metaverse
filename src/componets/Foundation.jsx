    ...
    <div class="px-3 md:lg:xl:px-40 py-20 bg-gradient-to-b from-black to-pink-900">
      <div class="grid grid-cols-1 md:lg:xl:grid-cols-3 gap-8 group rounded-xl">
              ...
              <a href="/documentation">
                      <div class="p-10 w-5/6 mx-auto bg-gray-900 flex flex-col items-center  text-center group  hover:bg-pink-700 cursor-pointer rounded-xl">
                ...
                <a href="http://metaverseofthings.blog">
                      <div class="p-10 w-5/6 mx-auto bg-gray-900 flex flex-col items-center  text-center group hover:bg-gray-200 cursor-pointer rounded-xl">
                          <span class="p-5 rounded-full bg-gradient-to-r from-black to-pink-900 text-white shadow-lg shadow-black"><svg
                                  xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" fill="none" viewBox="0 0 24 24"
                                  stroke="currentColor" stroke-width="1.5">
                                  <path stroke-linecap="round" stroke-linejoin="round"
