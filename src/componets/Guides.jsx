    ...
    <div class="mx-auto max-w-[30rem]">
      <div class="text-center">
        ...
        <h1 class="mt-2 text-[3.5rem] font-bold leading-[4rem] tracking-tight text-white">Metaverse <br></br><span className='text-indigo-600'>of Things</span></h1>
            <p class="mb-8 text-lg font-medium leading-8 text-indigo-600/95">Networking</p>
      ...
      <div class=" bg-gradient-to-b from-gray-900 to-gray-400  p-6 shadow-lg rounded-2xl flex justify-between items-center">
