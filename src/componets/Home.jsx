            ...
            <div name="about" className='w-full h-100 bg-gradient-to-b from-indigo-900 to-indigo-600'>
                            ...
                            <div class="h-96">
                                ...
                                <div class="bg-white  rounded-md">
                                    <div class="bg-white rounded-md list-none  text-center mt-8">
                                        <li class="py-3 rounded-md border-b-2 hover:bg-slate-50 cursor-pointer"><a href="https://www.metaverseot.xyz/" class="list-none  hover:text-indigo-600">Home</a></li>
                                        <li class="py-3 rounded-md border-b-2 hover:bg-slate-50 cursor-pointer"><a href="https://www.metaverseot.xyz/getstarted" class="list-none  hover:text-indigo-600">Get Started</a></li>
                    ...
                    <div class="container mx-auto p-2 px-4">
                        ...
                        <div className='w-full px-10 h-100 bg-gradient-to-b from-indigo-800 to-black'> 
                            <div className='p-10 w-full container mx-auto flex flex-col justify-center gap-10'>

                            <section class="relative py-20 flex flex-col items-center overflow-hidden md:py-40">
